...
import {Facebook, GitHub, Linkedin, CornerUpRight, CornerRightUp, ArrowRight, ArrowLeft} from 'react-feather'
...
const ProjectOne = ({pos}) =>
  ...
  <div style={{position:"relative", height:"5vh", color:"white"}}>
    <h3 style={{fontSize: "3vh"}}>Project 1: Reference-Dojo (Django)</h3>
  </div>
...
const ProjectTwo = ({pos}) =>
  ...
  <div style={{position:"relative", height:"5vh", color:"white"}}>
    <h3 style={{fontSize: "3vh"}}>Project 2: Don't Let It Rain</h3>
  </div>
  <div className="imageBox">
    <img style={{width: "100%",height:"auto"}} src={project2}/>
  </div>
...
<div className="imageBox">
  <ReactPlayer url="https://www.youtube.com/watch?v=od-e1Z3sPCE" />
</div>
<div className="textBox" style={{textAlign:"left"}}>
